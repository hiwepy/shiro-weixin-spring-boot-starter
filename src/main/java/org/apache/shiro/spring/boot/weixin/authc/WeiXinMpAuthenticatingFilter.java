 ...
 */
public class WeiXinMpAuthenticatingFilter extends AbstractTrustableAuthenticatingFilter {

	private static final Logger LOG = LoggerFactory.getLogger(WeiXinMpAuthenticatingFilter.class);
	...
	public WeiXinMpAuthenticatingFilter(WxMpService wxMpService) {
		super();
